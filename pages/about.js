...
const Editor = (props) => {
    return (
        <figure className="snip1515">
            <div className="profile-image"><img src={props.image} alt="editor" className="teamimg" /></div>
            <figcaption>
                <h3>{props.name}</h3>
                <h4>{props.role}</h4>
            </figcaption>
        ...
        <section className={styles.texture}>
            ...
            <Container className="my-5">
                ...
                <div className="d-flex mx-auto flex-wrap mt-3 justify-content-center">
                    <Editor name="জগত গগৈ" role="সম্পাদক" image={require('../public/images/jagat.jpeg')} />
                    <Editor name="দিব্যৰঞ্জণ বৰা" role="সহযোগী সম্পাদক" image={require('../public/images/dibya.jpeg')} />
                    <Editor name="হৰিপ্ৰসন্ন শইকীয়া" role="ক্ৰীড়া সম্পাদক" image={require('../public/images/hari.jpeg')} />
                    <Editor name="মৃদুল ফুকন" role="সহযোগী সম্পাদক" image={require('../public/images/mridul.jpeg')} />
                    <Editor name="সমীন কুমাৰ শইকীয়া" role="সহযোগী সম্পাদক" image={require('../public/images/xamin.jpeg')} />
                </div>
            </Container>
